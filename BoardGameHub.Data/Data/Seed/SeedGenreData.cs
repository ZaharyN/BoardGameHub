...
namespace BoardGameHub.Data.Data.Seed
{
    internal class SeedGenreData
    {
        ...
        public Genre EnvironmentalGenre { get; set; }
        public Genre EducationalGenre { get; set; }
        public Genre CivilizationGenre { get; set; }
        ...
        private void SeedGenres()
        {
            ...
            NegotiationGenre = new Genre()
            {
                Id = 18,
                Name = "Negotiation"
            };

            TrainsGenre = new Genre()
            {
                Id = 19,
                Name = "Trains"
            };
            ...
            EnvironmentalGenre = new Genre()
            {
                Id = 22,
                Name = "Environmental"
            };

            EducationalGenre = new Genre()
            {
                Id = 23,
                Name = "Educational"
            };

            CivilizationGenre = new Genre()
            {
                Id = 24,
                Name = "Civilization"
            };
